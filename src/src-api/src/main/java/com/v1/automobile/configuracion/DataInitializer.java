	...
	public void run(String... args) throws Exception {
		...
		try {
			...
			List<Usuario> usuarios = List.of(
					...
					new Usuario(5, "sarah_jones", "sarah.jones@gmail.com", "", passwordEncoder.encode("password"),
							"USER"),
					new Usuario(6, "alice_walker", "alice.walker@gmail.com", "", passwordEncoder.encode("password"),
							"USER"),
					new Usuario(7, "david_martin", "david.martin@gmail.com", "", passwordEncoder.encode("password"),
							"USER"),
					new Usuario(8, "olivia_smith", "olivia.smith@gmail.com", "", passwordEncoder.encode("password"),
							"USER"),
					new Usuario(9, "mason_johnson", "mason.johnson@gmail.com", "", passwordEncoder.encode("password"),
							"USER"),
			...
			List<Coche> coches = List.of(
					new Coche(1L, "Toyota", "Corolla", "https://cdn.motor1.com/images/mgl/P3gQyK/s1/corolla-grs-1.jpg",
							...
							usuarios.get(0), new ArrayList<Imagen>(), new ArrayList<Favorito>()),
					new Coche(2L, "Ford", "F-150",
							...
							"john_doe@gmail.com", usuarios.get(0), new ArrayList<Imagen>(), new ArrayList<Favorito>()),
